...
namespace SB3Utility
{
	public static class Extensions
	{
		...
		{
			return (uint)reader.ReadInt32BE();
		}

		public static void WriteUInt32BE(this BinaryWriter writer, uint val)
		{
		...
		public static Half ReadHalfFloat(this BinaryReader reader)
		{
			Half h = new Half();
			h.RawValue = reader.ReadUInt16();
			return h;
		}

		public static Single ReadHalfFloatAsFloat(this BinaryReader reader)
		{
			Half h = new Half();
			h.RawValue = reader.ReadUInt16();
			return h;
		...
		public static void WriteHalfFloat(this BinaryWriter writer, Half h)
		{
			writer.Write(h.RawValue);
		}

		public static void WriteHalfFloatFromFloat(this BinaryWriter writer, float value)
		{
